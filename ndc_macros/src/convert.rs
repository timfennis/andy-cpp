    ...
    fn convert(
        ...
        vec![Argument {
            ...
            initialize_code: quote! {
                let ndc_interpreter::value::Value::Sequence(ndc_interpreter::sequence::Sequence::String(#temp_var)) = #argument_var_name else {
...
impl TypeConverter for InternalMap {
    ...
    fn convert(
        ...
        vec![Argument {
            ...
            argument: quote! { #argument_var_name },
            initialize_code: quote! {
                let ndc_interpreter::value::Value::Sequence(ndc_interpreter::sequence::Sequence::Map(#temp_var, _)) = #argument_var_name else {
...
impl TypeConverter for InternalList {
    ...
    fn convert(
        ...
        vec![Argument {
            ...
            argument: quote! { #argument_var_name },
            initialize_code: quote! {
                let ndc_interpreter::value::Value::Sequence(ndc_interpreter::sequence::Sequence::List(#temp_var)) = #argument_var_name else {
                    panic!("Value #position needed to be Sequence::List but wasn't");
                };
...
//             argument: quote! { #argument_var_name },
//             initialize_code: quote! {
//                 let ndc_interpreter::value::Value::Sequence(ndc_interpreter::sequence::Sequence::Tuple(#temp_var)) = #argument_var_name else {
